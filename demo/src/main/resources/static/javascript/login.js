...
function validate(data){
    ...
    if(data.isAdmin == "true"){
        ...
        if(document.getElementById('feedback-selection').value == 'parentFeedback'){
          ...
          window.location.href = "/studentresponse.html";
      }
